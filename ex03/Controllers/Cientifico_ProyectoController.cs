...
namespace ex03.Controllers
{
    ...
    public class Cientifico_ProyectoController : ControllerBase
    {
        ...
        public Cientifico_ProyectoController(APIContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != cientifico_Proyecto.cientifico_dni)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Cientifico_Proyecto>> PostCientifico_Proyecto(Cientifico_Proyecto cientifico_Proyecto)
        {
          if (_context.cientifico_Proyectos == null)
          {
              return Problem("Entity set 'APIContext.cientifico_Proyectos'  is null.");
          }
            ...
            {
                if (Cientifico_ProyectoExists(cientifico_Proyecto.cientifico_dni))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetCientifico_Proyecto", new { id = cientifico_Proyecto.cientifico_dni }, cientifico_Proyecto);
        }
        ...
        {
            return (_context.cientifico_Proyectos?.Any(e => e.cientifico_dni == id)).GetValueOrDefault();
        }
    }
}
